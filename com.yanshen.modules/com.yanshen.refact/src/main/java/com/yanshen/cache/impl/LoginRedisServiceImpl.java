...
package com.yanshen.cache.impl;


import com.yanshen.bean.ClientInfo;
...
import com.yanshen.shiro.LoginSysUserVoConvert;
import com.yanshen.shiro.ShiroMapstructConvert;
import com.yanshen.util.ClientInfoUtil;
import com.yanshen.util.HttpServletRequestUtil;
import com.yanshen.util.RedisUtil;
import com.yanshen.vo.JwtTokenRedisVo;
...
public class LoginRedisServiceImpl implements LoginRedisService {
    ...
    public boolean exists(String token) {
        ...
        String tokenMd5 = DigestUtils.md5Hex(token);
        String rk =String.format(CommonRedisKey.LOGIN_TOKEN, tokenMd5);
        Object object = redisUtil.get(rk);//redisTemplate.opsForValue().get(rk);
        return object != null;
    }
