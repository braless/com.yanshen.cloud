//package com.yanshen.boot.rocketmq.listener;
//
//
//import com.alibaba.fastjson.JSONObject;
//import com.yanshen.boot.rocketmq.entity.OrderPaidEventTx;
//import com.yanshen.boot.rocketmq.util.JsonUtil;
...
//            JSONObject orderPaidEventTx = JSONObject.parseObject(json);
//
//            //执行本地事务，比如下单成功，存储订单信息。
//            assert orderPaidEventTx != null;
//            log.info("执行本地事务接收到到的消息内容为:{}", orderPaidEventTx);
//
//            //模拟现实中的业务逻辑
