...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        // 存入Cookie，以备使用
        args=new String[2];
        args[0]="BDUSS=FVUfjZNRHVEQVQxOHVEMX5TWS0yMnhtZ1NVT1p5UjBIUG9DbnZhc1dsU3NqYkJnSVFBQUFBJCQAAAAAAAAAAAEAAACwTTsiv-Bf0NDJrgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAKwAiWCsAIlgW;";
        if (args.length == 0) {
