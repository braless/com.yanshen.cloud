...
/**
 * @Auther: @Yanchao
 * @Date: 2023-09-12 17:37
 * @Description:
 * @Location: com.yanshen.shiro
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        List<Map<String, Object>> powerList = new ArrayList<>();//loginService.getUserPower(userName);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        //根据用户名去数据库查询用户信息
        SysUser sysUser = new SysUser();//loginService.queryUser(userName);
        if (sysUser == null) {
            //这里返回后会报出对应异常
            return null;
        } else {
