...
public class MybatisPlusGenerator {
    ...
    public  static String  url ="jdbc:mysql://61.139.65.135:31063/spring_shiro?useUnicode=true&characterEncoding=utf-8&userSSL=false&serverTimezone=GMT%2B8";
    public static  String user ="root";
    public static  String pwd=  "6d34761495ec289e"; //  "zksk666";  //;/
    ...
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create(
                new DataSourceConfig.Builder(url,
                        user,pwd))
                // 全局配置
                .globalConfig((scanner, builder) -> builder
                       ...
                       //.outputDir(projectPath + "/com.yanshen.generator/src/main/java/com.yanshen/")
                        .outputDir("D:\\github\\com.yanshen.cloud\\com.yanshen.shiro.jwt\\src\\main\\java\\com\\yanshen")
                )
                // 包配置
                //scanner.apply("请输入包名？")
...
//                )
                .packageConfig(builder -> {
                    builder.parent("") // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,"D:\\github\\com.yanshen.cloud\\com.yanshen.shiro.jwt\\src\\main\\resources\\mapper"));
                })
