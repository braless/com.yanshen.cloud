...
-- ----------------------------
BEGIN;
INSERT INTO `t_user` VALUES (1508421137384648705, '知否君', 12, 0, 'zhifoujun', '$2a$10$x9Yxwdhpk7Q.1yMU2e/h4eQ1yN3OFHuiIrBxst44FYLY6waJzRt22', '2022-03-28 07:29:59', NULL, 0);
COMMIT;
