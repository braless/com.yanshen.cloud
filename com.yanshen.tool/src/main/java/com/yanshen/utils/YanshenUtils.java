 ...
 **/
public class YanshenUtils {
    public static String E="Yanshen";
...
//            System.out.println("Random string of 10 alphanumeric characters: " + randomString);
    ...
    public static void main(String[] args) {
        YanshenUtils utils = new YanshenUtils();
        YanshenUtils.RandStr();
        System.out.println("start");
    }

    public YanshenUtils(){
        System.out.println("YanshenUtils was execed !");
    }

    public YanshenUtils(String a){
        System.out.println("YanshenUtils was execed !");
    }
