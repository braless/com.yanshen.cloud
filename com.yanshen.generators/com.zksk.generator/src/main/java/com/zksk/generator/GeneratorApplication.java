...
public class GeneratorApplication {
    ...
    public static void main(String[] args) {
        ...
        config.setOutputDir("D:\\github\\com.yanshen.cloud\\com.zksk.generator\\");
        //模块名称
        config.setModelName("credits");
        ...
        //项目包路径 格式：com.zksk
        config.setParent("com.zksk");
        ////数据库类型 mysqlDb或达梦（dmDb） 暂时只支持这两种-可针对数据库类型进行数据源切换设置
        config.setDbType("mysqlDb");
        //数据库配置相关
        config.setDataSourceUser("root");
        config.setDataSourcePwd("zksk666");
        config.setDataSourceUrl("192.168.20.99:3306");
        config.setDataSourceBank("zksk_credits_dev");
        //继承类绝对路径
        config.setSuperControllerClass("com.zksk.common.core.web.controller.BasePlusController");
        //继承类绝对路径
        config.setSuperEntityClass("com.zksk.common.core.web.domain.BasePlusEntity");
        //文件覆盖开关
